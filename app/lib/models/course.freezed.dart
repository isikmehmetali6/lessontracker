...
mixin _$Course {
  ...
  String? get location;
  Color get color;
  List<int> get scheduleDays; // 0 = Pazartesi, 6 = Pazar
  TimeOfDay get startTime;
  TimeOfDay get endTime;
  int get absenceLimit;
  int get currentAbsences;
  double get progress;
  String? get iconName;
  DateTime? get createdAt;
  DateTime? get nextExamDate;
  int get credits;
  String get status; // 'active', 'completed', 'archived'
  List<DateTime> get absenceDates;
  double? get latitude;
  double? get longitude;
  String? get professorEmail;
  String? get professorPhone;
  String? get professorOffice;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.absenceLimit, absenceLimit) ||
                other.absenceLimit == absenceLimit) &&
            (identical(other.currentAbsences, currentAbsences) ||
                other.currentAbsences == currentAbsences) &&
            ...
            (identical(other.nextExamDate, nextExamDate) ||
                other.nextExamDate == nextExamDate) &&
            (identical(other.credits, credits) || other.credits == credits) &&
            (identical(other.status, status) || other.status == status) &&
            const DeepCollectionEquality()
                .equals(other.absenceDates, absenceDates) &&
            (identical(other.latitude, latitude) ||
                other.latitude == latitude) &&
            (identical(other.longitude, longitude) ||
                other.longitude == longitude) &&
            (identical(other.professorEmail, professorEmail) ||
                other.professorEmail == professorEmail) &&
            (identical(other.professorPhone, professorPhone) ||
                other.professorPhone == professorPhone) &&
            (identical(other.professorOffice, professorOffice) ||
                other.professorOffice == professorOffice) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        credits,
        status,
        const DeepCollectionEquality().hash(absenceDates),
        latitude,
        longitude,
        professorEmail,
        professorPhone,
...
class _$CourseCopyWithImpl<$Res> implements $CourseCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? endTime = null,
    Object? absenceLimit = null,
    Object? currentAbsences = null,
    Object? progress = null,
    Object? iconName = freezed,
    Object? createdAt = freezed,
    Object? nextExamDate = freezed,
    Object? credits = null,
    Object? status = null,
    Object? absenceDates = null,
    Object? latitude = freezed,
    Object? longitude = freezed,
    Object? professorEmail = freezed,
    Object? professorPhone = freezed,
    Object? professorOffice = freezed,
    ...
    return _then(_self.copyWith(
      ...
      endTime: null == endTime
          ...
          : endTime // ignore: cast_nullable_to_non_nullable
              as TimeOfDay,
      absenceLimit: null == absenceLimit
          ? _self.absenceLimit
          : absenceLimit // ignore: cast_nullable_to_non_nullable
              as int,
      currentAbsences: null == currentAbsences
          ? _self.currentAbsences
          : currentAbsences // ignore: cast_nullable_to_non_nullable
              as int,
      ...
      createdAt: freezed == createdAt
          ...
          : createdAt // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      nextExamDate: freezed == nextExamDate
          ? _self.nextExamDate
          : nextExamDate // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      ...
      status: null == status
          ...
          : status // ignore: cast_nullable_to_non_nullable
              as String,
      absenceDates: null == absenceDates
          ? _self.absenceDates
          : absenceDates // ignore: cast_nullable_to_non_nullable
              as List<DateTime>,
      ...
      longitude: freezed == longitude
          ...
          : longitude // ignore: cast_nullable_to_non_nullable
              as double?,
      professorEmail: freezed == professorEmail
          ? _self.professorEmail
          : professorEmail // ignore: cast_nullable_to_non_nullable
              as String?,
      professorPhone: freezed == professorPhone
          ? _self.professorPhone
          : professorPhone // ignore: cast_nullable_to_non_nullable
              as String?,
      professorOffice: freezed == professorOffice
          ? _self.professorOffice
          : professorOffice // ignore: cast_nullable_to_non_nullable
              as String?,
    ...
    switch (_that) {
      case _Course() when $default != null:
        return $default(
            ...
            _that.latitude,
            _that.longitude,
            _that.professorEmail,
            _that.professorPhone,
            _that.professorOffice,
            _that.officeHours,
            _that.assistantName);
      case _:
        return orElse();
...
class _Course extends Course {
  const _Course(
      ...
      this.location,
      required this.color,
      required final List<int> scheduleDays,
      ...
      this.credits = 3,
      this.status = 'active',
      final List<DateTime> absenceDates = const [],
      this.latitude,
      this.longitude,
      this.professorEmail,
      this.professorPhone,
      this.professorOffice,
      this.officeHours,
      this.assistantName})
      : _scheduleDays = scheduleDays,
        _absenceDates = absenceDates,
        super._();
...
// 'active', 'completed', 'archived'
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.status, status) || other.status == status) &&
            const DeepCollectionEquality()
                .equals(other._absenceDates, _absenceDates) &&
            (identical(other.latitude, latitude) ||
                other.latitude == latitude) &&
            (identical(other.longitude, longitude) ||
                other.longitude == longitude) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        credits,
        status,
        const DeepCollectionEquality().hash(_absenceDates),
        latitude,
        longitude,
        professorEmail,
        professorPhone,
